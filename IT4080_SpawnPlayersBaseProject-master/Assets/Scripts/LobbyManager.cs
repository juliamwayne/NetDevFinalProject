...
public class LobbyManager : NetworkBehaviour
{
    ...
    {
        GameData.Instance.allPlayers.OnListChanged -= ClientOnAllPlayersChanged; //Quick reminder that it's bad to do this.that.this2 chain.
    }
    ...
    private void EnableStartIfAllReady() {
        ...
        */
        ...
        string txtButton = "Start";

        if(!btnStart.enabled)
        {
            txtButton = "<Waiting For Players To Be Ready>";
        }

        btnStart.GetComponentInChildren<TextMeshProUGUI>().text = txtButton;
    }
